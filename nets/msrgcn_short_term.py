...
class MSRGCNShortTerm(nn.Module):
    def __init__(self, p_dropout, leaky_c=0.2, final_out_noden=22, input_feature=35):
        ...
        self.first_down = nn.Sequential(
            SingleLeftLinear(input_feature=final_out_noden * 3, out_features=36, seq_len=256, p_dropout=p_dropout,
                             leaky_c=leaky_c),  # 66, 128, 64
        )

        self.second_enhance = PreGCN(input_feature=256, hidden_feature=256, node_n=36, p_dropout=p_dropout,
                                     leaky_c=leaky_c)
        self.second_left = nn.Sequential(
            GC_Block(in_features=256, p_dropout=p_dropout, node_n=36, leaky_c=leaky_c),
            GC_Block(in_features=256, p_dropout=p_dropout, node_n=36, leaky_c=leaky_c),
            GC_Block(in_features=256, p_dropout=p_dropout, node_n=36, leaky_c=leaky_c),
        )

        self.second_down = nn.Sequential(
            SingleLeftLinear(input_feature=36, out_features=21, seq_len=256, p_dropout=p_dropout, leaky_c=leaky_c),
            # 66, 36, 64
        )

        self.third_enhance = PreGCN(input_feature=256, hidden_feature=256, node_n=21, p_dropout=p_dropout,
                                    leaky_c=leaky_c)
        ...
        self.fourth_enhance = PreGCN(input_feature=256, hidden_feature=256, node_n=12, p_dropout=p_dropout,
                                     leaky_c=leaky_c)
        self.fourth_left = nn.Sequential(
            GC_Block(in_features=256, p_dropout=p_dropout, node_n=12, leaky_c=leaky_c),  # 64, 0.5, 66
            GC_Block(in_features=256, p_dropout=p_dropout, node_n=12, leaky_c=leaky_c),
            GC_Block(in_features=256, p_dropout=p_dropout, node_n=12, leaky_c=leaky_c),
        )
        ...
        self.fourth_up = nn.Sequential(
            SingleLeftLinear(input_feature=12, out_features=21, seq_len=256, p_dropout=p_dropout, leaky_c=leaky_c),
            SingleRightLinear(input_feature=256, out_features=256, node_n=21, p_dropout=p_dropout, leaky_c=leaky_c),
        )
        ...
        self.third_up = nn.Sequential(
            ...
            SingleRightLinear(input_feature=256, out_features=256, node_n=36, p_dropout=p_dropout, leaky_c=leaky_c)
        )

        self.second_right_crop = nn.Sequential(
            SingleLeftLinear(input_feature=72, out_features=36, seq_len=256, p_dropout=p_dropout, leaky_c=leaky_c),
        )
        ...
        self.second_up = nn.Sequential(
            SingleLeftLinear(input_feature=36, out_features=final_out_noden * 3, seq_len=256, p_dropout=p_dropout,
                             leaky_c=leaky_c),
            SingleRightLinear(input_feature=256, out_features=256, node_n=final_out_noden * 3, p_dropout=p_dropout,
                              leaky_c=leaky_c)
        )

        self.first_right_crop = nn.Sequential(
            SingleLeftLinear(input_feature=final_out_noden * 3 * 2, out_features=final_out_noden * 3, seq_len=256,
        ...
        self.first_out = PostGCN(input_feature=256, hidden_feature=input_feature, node_n=final_out_noden * 3)
        ...
        self.second_out = PostGCN(input_feature=256, hidden_feature=input_feature, node_n=36)
        ...
        self.fourth_out = PostGCN(input_feature=256, hidden_feature=input_feature, node_n=12)
